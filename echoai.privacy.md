Privacy Policy di EchoAI
Ultimo aggiornamento: 08/06/2026

Questa Privacy Policy descrive come EchoAI raccoglie, utilizza e protegge le informazioni degli utenti.
Utilizzando il bot, accetti i termini di questa informativa.

1. Dati raccolti
	•	EchoAI può raccogliere ID utente, ID server e messaggi solo per eseguire le funzionalità richieste.
